    ...
    public abstract class DbContext
    {
            ...
            using (new ConnectionManager(connection))
            {
                using (var transaction = connection.StartTransaction())
                {
                    foreach (IEnumerable dbSet in dbSets)
                    {
                        ...
                        catch (TargetInvocationException tieException)
                        {
                            throw tieException.InnerException;
                        }
        ...
        private bool IsObjectValid(object o)
        {
            ...
            var validationResult =
                Validator.TryValidateObject(o, validationContext, validationErrors, validateAllProperties: true);
